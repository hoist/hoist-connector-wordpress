  ...
  _createClass(WordpressPoller, [{
    ...
    value: function poll() {
      ...
      return this.assertCanPoll().then(function () {
        ...
        _this.context.subscription.delayTill((0, _moment3['default'])().add(5, 'minutes').toDate());
      })['catch'](function (err) {
    ...
    value: function generateUrlForEndpoint(endpoint) {
      ...
      return Promise.resolve().then(function () {
        var urlObj = {
          pathname: '/sites/' + _this4._context.authorization.get('SubscriptionProject') + '/' + endpoint.toLoweCase(),
          query: {}
        };
    ...
    value: function saveResultForEndpoint(endpoint, urls, result) {
      ...
      return Promise.resolve().then(function () {
        ...
        if (resultsForEndpoint.found === 0) {
          ...
          var _ret = (function () {
            var documents = resultsForEndpoint[endpoint.toLoweCase()];
            return {
    ...
    value: function raise(endpoint, document) {
      ...
      return Promise.resolve().then(function () {
        return _this7.emit(_this7._context.connectorKey + ':new:' + endpoint.toLoweCase());
      });
    }
  }]);
